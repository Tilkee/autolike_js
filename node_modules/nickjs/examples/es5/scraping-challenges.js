...
nick.newTab().then(function () {var _ref = (0, _asyncToGenerator3.default)(_regenerator2.default.mark(function _callee(tab) {var _ref2, code, status, newUrl, matchedSelector, _filename, filename;return _regenerator2.default.wrap(function _callee$(_context) {while (1) {switch (_context.prev = _context.next) {case 0:
						...
						console.log('>> open: ' + code + ' ' + status + ' ' + newUrl);_context.prev = 8;_context.next = 11;return (
							...
							'#email',
							'body > div > div'],
							30000, "or"));case 11:matchedSelector = _context.sent;_context.next = 21;break;case 14:_context.prev = 14;_context.t0 = _context['catch'](8);_context.next = 18;return (

							tab.screenshot("error.png"));case 18:_filename = _context.sent;
						console.log("Screenshot " + _filename + " saved");throw _context.t0;case 21:



						console.log("selector that matched: " + matchedSelector);_context.next = 24;return (
						...
						console;_context.next = 27;return tab.getUrl();case 27:_context.t2 = _context.sent;_context.t3 = "the page URL is: " + _context.t2;_context.t1.log.call(_context.t1, _context.t3);_context.next = 32;return (

							tab.sendKeys("#email", "totokjsd"));case 32:

						console.log("Waiting 1s...");_context.next = 35;return (
							Promise.delay(1000));case 35:_context.next = 37;return (

							tab.screenshot("test1.png"));case 37:filename = _context.sent;
						console.log("Screenshot " + filename + " saved");_context.next = 41;return (

							tab.fill("form", {
								"email": "john@doe.com",
								"password": "johnjohn" },
							{ submit: true }));case 41:_context.next = 43;return (

							tab.untilVisible("div.name.property-value"));case 43:_context.next = 45;return (

							tab.screenshot("test2.png"));case 45:filename = _context.sent;
					...
					case 47:case 'end':return _context.stop();}}}, _callee, undefined, [[8, 14]]);}));return function (_x) {return _ref.apply(this, arguments);};}()).
then(function () {

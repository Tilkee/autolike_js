	...
	function TabDriver(uniqueTabId, options) {var _this = this;(0, _classCallCheck3.default)(this, TabDriver);
		...
		if (options.printPageErrors) {
			this.__casper.on('page.error', function (err) {
				console.log("> Tab " + _this.id + ": Page JavaScrit error: " + err);
			});
		}
		...
		} }, { key: "casper", get: function get() {return this.__casper;} }, { key: "closed", get: function get() {return this.__closed;} }, { key: "id", get: function get() {return this.__uniqueTabId;} }]);return TabDriver;}();

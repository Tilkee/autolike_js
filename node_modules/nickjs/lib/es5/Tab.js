...
Tab = function () {
	...
	function Tab(nick, tabDriver) {(0, _classCallCheck3.default)(this, Tab);
		...
		url) {var _this3 = this;var options = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};var callback = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : null;
			...
			return this._callToTabDriver(function (callback) {_this3._tabDriver._open(url, options, callback);}, callback, true);
		} }, { key: "isVisible", value: function isVisible(

		selectors) {var operator = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : null;var callback = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : null;return this._isVisibleOrPresent("_waitUntilVisible", selectors, operator, callback);} }, { key: "isPresent", value: function isPresent(
		...
		{var _this15 = this;var callback = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : null;
			return this._callToTabDriver(function (callback) {_this15._tabDriver._scrollToBottom(x, y, callback);}, callback);
		...
		cookie, callback) {return this.nick.setCookie(cookie, callback);} }, { key: "nick", get: function get() {return this._nick;} }, { key: "driver", get: function get() {return this._tabDriver;} }, { key: "tabDriver", get: function get() {return this._tabDriver;} }, { key: "actionInProgress", get: function get() {return this._actionInProgress;} }, { key: "closed", get: function get() {return this._tabDriver.closed;} }, { key: "id", get: function get() {return this._tabDriver.id;} }, { key: "onConfirm", set: function set(f) {if (typeof f !== "function") {throw new TypeError("onConfirm must receive a function");}this._tabDriver._onConfirm = f;} }, { key: "onPrompt", set: function set(f) {if (typeof f !== "function") {throw new TypeError("onPrompt must receive a function");}this._tabDriver._onPrompt = f;} }]);return Tab;}();
